...
class ScenarioLoaderMedQA:
    def __init__(self) -> None:
        with open("dataset/StructuredData/agentclinic_medqa.jsonl", "r") as f:
...
class ScenarioLoaderMedQAExtended:
    def __init__(self) -> None:
        with open("dataset/StructuredData/agentclinic_medqa_extended.jsonl", "r") as f:
            self.scenario_strs = [json.loads(line) for line in f]
...
class ScenarioLoaderMIMICIV:
    def __init__(self) -> None:
        with open("dataset/StructuredData/agentclinic_mimiciv.jsonl", "r") as f:
            self.scenario_strs = [json.loads(line) for line in f]
...
class ScenarioLoaderNEJMExtended:
    def __init__(self) -> None:
        with open("dataset/StructuredData/agentclinic_nejm_extended.jsonl", "r") as f:
            self.scenario_strs = [json.loads(line) for line in f]
...
class ScenarioLoaderNEJM:
    def __init__(self) -> None:
        with open("dataset/StructuredData/agentclinic_nejm.jsonl", "r") as f:
            self.scenario_strs = [json.loads(line) for line in f]
